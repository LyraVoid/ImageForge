...
|---|---|---|---|---|---|
| lzma-rust2 | https://github.com/hasenbanck/lzma-rust2/ | 0.21.0 | `fde178a3caf126c440fa15628147772d8ee590a39477d711353fbe2e58a73a5b` | Apache-2.0 | xz / LZMA2 streams: the same crate and version magiskboot uses, so re-compressed ramdisks agree with it. |
